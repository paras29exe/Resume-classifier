...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='paras.admin',db='resumeanalyzer')
...
def run():
    ...
    link = '<b>Built with 🤍 by Paras, Aryan, Abhishek and Koshal' 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Paras ! Total %d " % values + " User's Have Used Our Tool : )")                
